...
export const DashboardComponent = () => {
  ...
  const handleAddToCart = (item: { cardID: any; shoeName: string; price: any; cardImg: string; tag: string}) => {
  ...
  return (
    ...
    <Fragment>
      ...
      <div className="grid grid-cols-7 h-full gap-5 mt-5">
        <div className="col-span-7 xl:col-span-5 h-full">
          <TopDashboardCard />
        </div>
        <div className="col-span-7 xl:col-span-2 h-full">
          <div className="bg-[#E4E4E4] relative h-full overflow-hidden rounded-lg py-[43px] px-[17px]">
            ...
            <div className="bg-white rounded-lg" key={index}>
              ...
              <div className="grid grid-cols-2">
                <div className="col-span-1">
                  <button className="bg-black uppercase text-xs py-3 w-full text-white" onClick={() => handleAddToCart(item)}>Add to cart</button>
                </div>
                <div className="col-span-1">
